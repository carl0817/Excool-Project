...
fmripath = '/local_raid3/03_user/sunghyoung/02_data/Forrestgump/forrestgump_fmri/sub-01/ses-movie/func/';
% filename = '/seg1/cifti/seg1_1_Atlas.dtseries.nii';
filename = 'sub-01_ses-movie_task-movie_run-1_bold.nii.gz';
...
addpath(genpath('/local_raid3/03_user/sunghyoung/01_project/03_Encoding_decoding/01_NeuralEncodingDecoding/sourcecode/source_code_v2/source_code_v2/subfunctions'))
...
fmripath = '/local_raid1/03_user/sunghyoung/01_project/03_Encoding_decoding/01_NeuralEncodingDecoding/subject1/video_fmri_dataset/subject1/fmri/'; % path to the cifti files
